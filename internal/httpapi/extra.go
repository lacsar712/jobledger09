...
import (
	...
	"example.com/jobledger/internal/backup"
	"example.com/jobledger/internal/model"
	"example.com/jobledger/internal/policy"
	"example.com/jobledger/internal/report"
	"example.com/jobledger/internal/validate"
	"example.com/jobledger/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=jobledger.zip")
	_, _ = w.Write(b)
}
